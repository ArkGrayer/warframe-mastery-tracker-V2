    ...
    reader.onload = async (e) => {
      try {
        ...
        const updatedProfile = {
          ...
          acquired: Array.from(new Set([...profile.acquired, ...(legacyData.acquired || [])])),
          mastered: Array.from(new Set([...profile.mastered, ...(legacyData.mastered || [])])),
        };
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-10 relative z-10">
        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <p className="text-[11px] text-[#8a7a9b] leading-relaxed opacity-60">
            ...
            All artwork, screenshots, characters or other recognizable features of the intellectual property relating to 
            these trademarks are likewise the intellectual property of Digital Extremes Ltd.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="text-xs font-bold text-[#8a7a9b] uppercase tracking-widest flex items-center gap-2">
            ...
            <div className="relative group cursor-pointer inline-block ml-1">
              <span className="text-[#f0e6d3] font-black transition-colors group-hover:text-[#4cc9ff]">
                Igor Feitosa
              </span>
          ...
          <div className="pt-4 border-t border-[#1e1a2e] w-full flex flex-col items-center">
            ...
            >
              ...
              <span>{loading ? "Sincronizando..." : "Sincronizar Arquivos do Santuário Legado"}</span>
            </button>
          </div>
        </div>
      </div>
